...
if (tby_debug_mode) {
	...
	_d += "textboxy version " + global.__tby.version + " (scribble v" + __SCRIBBLE_VERSION + ")\n";
	_d += "tby.frames_list:\n" + _ds_list_to_string(global.__tby.frames_list, ",\n", 4);
	_d += "tby.pause_callbacks_list:\n" + _ds_list_to_string(global.__tby.pause_callbacks_list, ",\n", 4);
