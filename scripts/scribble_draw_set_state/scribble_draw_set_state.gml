...
global.scribble_state_min_width       = argument0[SCRIBBLE_STATE.MIN_WIDTH            ];
...
global.scribble_state_tw_position     = argument0[SCRIBBLE_STATE.TYPEWRITER_POSITION  ];
global.scribble_state_tw_smoothness   = argument0[SCRIBBLE_STATE.TYPEWRITER_SMOOTHNESS];
