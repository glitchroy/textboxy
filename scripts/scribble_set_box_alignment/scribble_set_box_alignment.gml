...
if (_halign == fa_left)
{
    ...
    _json[| __SCRIBBLE.RIGHT ] = _width;
}
else if (_halign == fa_center)
{
    _json[| __SCRIBBLE.LEFT  ] = -_width div 2;
    _json[| __SCRIBBLE.RIGHT ] =  _width div 2;
}
else if (_halign == fa_right)
{
    _json[| __SCRIBBLE.LEFT  ] = -_width;
...
if (_valign == fa_top)
{
    ...
    _json[| __SCRIBBLE.BOTTOM ] = _height;
}
else if (_valign == fa_middle)
{
    _json[| __SCRIBBLE.TOP    ] = -_height div 2;
    _json[| __SCRIBBLE.BOTTOM ] =  _height div 2;
}
else if (_valign == fa_bottom)
{
    _json[| __SCRIBBLE.TOP    ] = -_height;
