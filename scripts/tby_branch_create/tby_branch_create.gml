...
/// @param _command_list
function tby_branch_create(argument0) {
	...
	_branch[@TbyBranch.message_list] = _tby_list_create();
	_tby_branch_nested_array_add(_branch, _command_list);
	...
	_tby_branch_config_set_defaults(_branch);
