...
var tb = instance_create_layer(tsize[TbySize.x], tsize[TbySize.y], tbyLayerText, objTextbox)

with (tb) {
    // This is run after objTextbox CREATE event, but before the INIT state
